...
NSString *const JHRefreshHeaderStatusTextNormal = @"";
NSString *const JHRefreshHeaderStatusTextPulling = @"";
NSString *const JHRefreshHeaderStatusTextRefreshing = @"";
NSString *const JHRefreshHeaderStatusTextSuccess = @"";
NSString *const JHRefreshHeaderStatusTextFailure = @"";

NSString *const JHRefreshFooterStatusTextNormal = @"";
NSString *const JHRefreshFooterStatusTextPulling = @"";
NSString *const JHRefreshFooterStatusTextRefreshing = @"";
NSString *const JHRefreshFooterStatusTextSuccess = @"";
NSString *const JHRefreshFooterStatusTextFailure = @"";
